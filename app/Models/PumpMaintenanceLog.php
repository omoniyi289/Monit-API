...
class PumpMaintenanceLog extends Model
{
    ...
    protected $fillable = ['company_id', 'product_id','station_id','combined_pump_nozzle_code',"pump_1_nozzle_code","pump_2_nozzle_code","totalizer_1_reading","totalizer_2_reading","combined_totalizer_reading","D_invoice_number","D_issue_date","D_maintenance_date","MD_invoice_number","MD_issue_date","MD_maintenance_date","MMD_invoice_number","MMD_issue_date","MMD_maintenance_date","note","created_by", "product"];
