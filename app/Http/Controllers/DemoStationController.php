...
use App\Services\DemoStationService;
use App\Services\UserService;
use App\Util;
use Core\Controllers\BaseController;
use Illuminate\Http\Request;

class DemoStationController extends BaseController implements GenericInterface
{
    ...
    public function __construct(DemoStationService $station_service,
