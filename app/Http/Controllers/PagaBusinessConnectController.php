...
class PagaBusinessConnectController extends BaseController
{

    public function connect(Request $request){
       $url = "https://mypaga.com/paga-webservices/business-rest/secured/transactionHistory";
 ...
 curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-Type: application/json","principal: 81A61504-4ED6-4605-8DD5-A3128C75E7B9","credentials: mZ2+=YE4UVMH6EE","hash:".$hash
    ));
    $output=curl_exec($ch);
