            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td bgcolor="#ffffff" align="center" valign="top"
                        ...
                        <h1 style="font-size: 42px; font-weight: 400; margin: 0;">Hi {{ $station['manager_name'] }}</h1>
                    </td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
                ...
                <!-- COPY -->
                 ...
                 <tr>
                    <td bgcolor="#ffffff" align="left"
                        ...
                        <p style="margin: 0;">
    {{$data['quantity_loaded']}} Litres truck with registration Tag no {{$data['truck_reg_number']}} is enroute your station to deliver {{$data['product_name']}}.
<br>
All compartments are sealed with {{ $station['name'] }} Seal numbers. 
<br><br>
 
    @foreach($data['latest_seal_numbers'] as $seal_no)
        @if( isset($data['new_seal_numbers'][$loop->index]) and $data['new_seal_numbers'][$loop->index] !== $data['latest_seal_numbers'][$loop->index] )
        {{$seal_no}}  with {{$data['latest_seal_quantities'][$loop->index]}} Litres Replaced with {{$data['new_seal_numbers'][$loop->index]}}  with {{$data['new_seal_quantities'][$loop->index]}} Litres <br>
        @else
        {{$seal_no}}  with {{$data['latest_seal_quantities'][$loop->index]}} Litres <br>
        @endif
    @endforeach

<br><br>
 Kindly ensure tank readiness.            
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="center"
                        ...
                        <p style="margin: 0;">Copyright © 2018 Station manager. All rights reserved.</p>
                    </td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
