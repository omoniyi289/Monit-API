            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td bgcolor="#ffffff" align="center" valign="top"
                        ...
                        <h1 style="font-size: 42px; font-weight: 400; margin: 0;">Hi {{ $user['fullname'] }}</h1>
                    </td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td bgcolor="#ffffff" align="left"
                        ...
                        <p style="margin: 0;">A Velox customer credit limit change request with the details below has been uploaded. Please  <a href="{{env('FRONTEND_URL')}}/#/index">
                                                    LOGIN </a> to the Station Manager app to approve or disapprove the request. Thanks</p>
                    </td>
                </tr>
                 <tr>
                    <td bgcolor="#ffffff" align="left"
                        style="padding: 10px 10px 10px 10px; color: #666666; font-family: 'Poppins', sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
                        <p style="margin: 0;">
                            Requested by : {{$data['limit_requested_by']}}<br>
                            Velox Customer : {{$data['selected_customer']['name']}}<br>
                            Current Credit Limit : NGN {{$data['current_creditlimit']}}<br>
                            Requested Credit Limit: NGN {{$data['requested_creditlimit']}}<br>
