            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td bgcolor="#ffffff" align="left"
                        ...
                        <p style="margin: 0;">A Velox customer payment with the details below has been uploaded. Please  <a href="{{env('FRONTEND_URL')}}/#/index">
                                                    LOGIN </a> to the Station Manager app to approve or disapprove the payment. Thanks</p>
                    </td>
                </tr>
                 <tr>
                    <td bgcolor="#ffffff" align="left"
                        style="padding: 10px 10px 10px 10px; color: #666666; font-family: 'Poppins', sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
                        <p style="margin: 0;">
                            Uploaded by : {{$data['uploaded_by']}}<br>
                            Velox Customer : {{$data['selected_customer']['name']}}<br>
                            Amount Paid: NGN {{$data['amount_paid']}}<br>
