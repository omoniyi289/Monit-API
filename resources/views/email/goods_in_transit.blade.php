                ...
                <!-- COPY -->
                 ...
                 <tr>
                    <td bgcolor="#ffffff" align="left"
                        ...
                        Kindly note that there will be {{$data['quantity_loaded']}} Litres delivery of {{$data['product_name']}} at your station.
                        <br>
                        All compartments are sealed with {{ $station['name'] }} Seal numbers. 
<br><br>
 

Truck Registration Tag: {{$data['truck_reg_number']}}
<br><br>
 

Seal Nos:
<br>
    @foreach($data['first_seal_numbers'] as $seal_no)
        {{$seal_no}} with {{$data['first_seal_quantities'][$loop->index]}} Litres <br>
    @endforeach
