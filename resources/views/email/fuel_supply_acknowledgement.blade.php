            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td bgcolor="#ffffff" align="center" valign="top"
                        ...
                        <h1 style="font-size: 25px; font-weight: 400; margin: 0;">Hi {{$user['fullname']}}</h1>
                    </td>
                </tr>
            </table>
         <!--[if (gte mso 9)|(IE)]>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td bgcolor="#ffffff" align="left"
                        ...
                        <p style="margin: 0;">A fuel request with the details below has been approved and currently awaiting an acknowledgement.</p>
                    </td>
                </tr>
                 <tr>
                    <td bgcolor="#ffffff" align="left"
                ...
                <tr>
                    <td bgcolor="#ffffff" align="left"
                        style="padding: 10px 10px 10px 10px; color: #666666; font-family: 'Poppins', sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
                        <p style="margin: 0;">
                           Click the button below to acknowledge that the approved Request Order is in Process
                        </p>
                    </td>
                </tr>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="border-radius: 3px;" bgcolor="green">
                                                <a href="https://www.e360stationmanager.com/#/fuel-supply/validate-request?external_query=true&request_code={{$request_code}}&user_id={{$user['id']}}&status=Order in Process"
